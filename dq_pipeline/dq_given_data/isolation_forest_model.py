...
def evaluate(model, imputer, X_test, y_test, test_meta):
    ...
    return {"model": "Isolation Forest", "precision": round(precision,4),
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print(f"  ISOLATION FOREST — {config.ACTIVE_DATASET.upper()}")
    print("=" * 60)
